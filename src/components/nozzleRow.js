...
export default class extends React.PureComponent {
    render = () => {
        const { showToggle, toggle, itemKey, name, type, picks, placements, poss_missing, comp_missing, reject_sum, reject_sum_percent, reject_factor, active } = this.props;
        ...
        return (
          <Row
            ...
            data-id={itemKey}
            onClick={toggle}
            className={`toggle-row border-bottom ${active}`}
          >
